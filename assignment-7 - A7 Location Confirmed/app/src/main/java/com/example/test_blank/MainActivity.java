...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button4 = findViewById(R.id.prime_directive_button);
        Button button5 = findViewById(R.id.location_confirmed_activity_button);
        ...
        button4.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
                android.content.Intent intent = new android.content.Intent(MainActivity.this, PrimeDirective.class);
                startActivity(intent);
            }
        });
        ...
        button5.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
                android.content.Intent intent = new android.content.Intent(MainActivity.this, LocationConfirmed.class);
                startActivity(intent);
            }
        });
    }
